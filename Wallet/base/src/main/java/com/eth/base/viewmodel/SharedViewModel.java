...
public class SharedViewModel extends ViewModel {
     ...
     * 皮重
     */
    public final MutableLiveData<String> netWeight = new MutableLiveData<>();
    public final MutableLiveData<String> pnNetWeight = new MutableLiveData<>();
    public final MutableLiveData<Integer> weightStatus = new MutableLiveData<>();
